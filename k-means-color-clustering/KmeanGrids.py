...
def computeDominantHSVinGrid(framNum,frame, grid_params,csv_file,inputVideoFile):
...
def process_video(inputVideoFile):
    ...
    csvFilePath="OutCSV/"+str(inputVideoFile).split('0')[0]+".csv"
    ...
    while(cap.isOpened()):
        ...
        computeDominantHSVinGrid(frameNum,frame_optical, grid_params, csv_file=csvFilePath, inputVideoFile=inputVideoFile)
